...
import { DollarSign, TrendingUp, UserPlus, ShoppingCart } from 'lucide-react';
...
const CustomYAxisTick = ({ y, payload }: any) => {
  return (
    <g transform={`translate(0,${y})`}>
      <text x={0} y={0} dy={4} textAnchor="start" fill="#666" style={{ fontSize: 12 }} className="truncate">
        {payload.value}
      </text>
    </g>
  );
...
export default function AnalyticsClient({ products, users, orders }: AnalyticsClientProps) {
